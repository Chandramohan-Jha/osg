...
import Group_74145 from "../../Images/Group_74145.svg";
    ...
    <>
                  ...
                  >
                    <div style={{ width: "544px" }}>
                      <div style={{ fontSize: "36px" }} className="sm-18">
                        <b>Transforming lives through Technology</b>
                      </div>
                      <div style={{ fontSize: "18px" }} className="mt-4 sm-14">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Id repellendus modi quis qui, earum maiores?
                      </div>
                      <button
                ...
                <div className="container">
                  ...
                  >
                    <div style={{ width: "544px" }}>
                      ...
                      <div style={{ fontSize: "18px" }} className="mt-4 sm-14">
                       Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat harum dolore, facilis dolores ea vero.
                       </div>
                      <button
                        className="btn btn-km-1 mt-5 "
                        onClick={() => navigate("/about")}
                ...
                <div className="container">
                  ...
                  >
                    <div style={{ width: "544px" }}>
                      ...
                      <div style={{ fontSize: "18px" }} className="mt-4 sm-14">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos ab odit deserunt voluptatibus iure sed!
                      </div>
                      <button
                        className="btn btn-km-1 mt-5"
                        onClick={() => navigate("/about")}
      ...
      >
        <div className="container" style={{ position: "relative" }}>
          ...
          <div
            className="d-flex align-items-center justify-content-between sm-scroll sm-gap-20"
            data-aos="fade-up"
          >
            <div style={{ marginTop: "35px" }}>
              <div style={{ color: "#C51213", fontSize: "30px" }}>
                <b className="sm-25">25+</b>
              </div>
              <div
                style={{ color: "#555554", fontSize: "18px" }}
                className="mt-2 sm-16"
              >
                Years of Experience
              </div>
            </div>
          ...
          <div className="car_effect_002">
            <img src={Group_74145} alt="error" />
          </div>
        </div>
      </div>

      <div className="sm-mt-4" data-aos="fade-up">
        ...
        <div className="pas_box_2" data-aos="fade-up">
          <div className="pas_box_1">
            <div className="container sm-mt-4" style={{ position: "relative" }}>
              ...
              <div
                ...
                className="d-flex align-items-end justify-content-between sm-scroll sm-gap-10"
              >
                <div
                  className={
                    alliance === 1
          ...
          <div className="pas_box_1 sm-mt-4" data-aos="fade-up">
            <div className="container" style={{ position: "relative" }}>
              <img
                src={Component_226_5}
                alt="logo"
      ...
      <div className="caseStudy" data-aos="fade-up">
        ...
        >
          ...
          <div className="d-flex justify-content-between srolling_effect mt-2  ">
      ...
      <div className="blog_post sm-mt-4 sm-pt3" data-aos="fade-up">
        <div className="container" style={{ position: "relative" }}>
          <img
            src={Component_226_5}
            alt="logo"
          ...
          >
            ...
            <div style={{ color: "#C51213" }} className="fifteen">
              <u>EXPLORE</u>
            </div>
          </div>
          <div
      ...
      <div className=" testimonial sm-mt-4 sm-pt3" data-aos="fade-right">
        <div className="container" style={{ position: "relative" }}>
          <img
            src={Component_226_5}
            alt="logo"
          ...
          <div style={{ paddingTop: "50px" }}>
            <div className="row">
              ...
              <div className="col-lg-4 col-md-4 col-12" data-aos="flip-right">
      ...
      <div className="contact sm-pt3" data-aos="fade-up">
        ...
        <div className="container sm-mt-4">
          <div className="row">
            <div className="col-lg-4 col-md-4 col-12">
              <div style={{ color: "#000000", fontSize: "40px" }}>
