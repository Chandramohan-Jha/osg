    ...
    return (
        <>
            <div className="contact_us">
                <MainHeader img="c_img_contact sm-img" name="Contact Us" title="We Are waiting for you" />
                <div className="co-orprate">
                    <div className="container" style={{ position: 'relative' }}>
                        <img src={Component_226_5} alt="logo" className="car_effect_03 sm-none" />
                        <div className="thirty" style={{ color: "#00155A", paddingTop: "10px" }} data-aos="fade-up"><b className='sm-25'>Corporate Office</b></div>
                        <div style={{ paddingTop: "45px", color: "#00155A", fontSize: "18px" }}>
                            <div data-aos="fade-up">
                                281, V mall, Western Express Highway, Near Thakur Complex, Kandivali, Gayatri Nagar, Asha Nagar, Kandivali East, Mumbai, Maharashtra, India
                            </div>
                            <div data-aos="fade-up" style={{ marginTop: "50px" }}>+91 88532 99293 <br />email us: customercare@carcrafts.in <br /><br /><br />06:00 am – 10:00 pm (open today)</div>
                        </div>
                        <div data-aos="fade-left" className="d-flex align-items-center" style={{ gap: "38px", marginTop: "90px" }}>
