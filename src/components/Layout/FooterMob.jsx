...
// Images
import Path_115225 from '../../Images/Path_115225.svg';
    ...
    <>
      <div className="footer_mob">
        <div className="container">
          <div
            className="d-flex justify-content-center sm-pb2"
            onClick={() => navigate("/")}
          >
            <img src={Path_115225} alt="logo" width="164px" height="44px" />
          </div>
          <div
            className="d-flex align-items-center justify-content-between footer_mob_border sm-pb2"
            style={{ width: "100%", paddingTop: "20px", cursor: "pointer" }}
          >
          ...
          <div className="footer_mob_border sm-pt2">
            <div className="sm-14 text-center">
              <b>OM SAI CORPORATION© 2021. All rights Reserved.</b>
            </div>
          </div>
        </div>
      </div>
