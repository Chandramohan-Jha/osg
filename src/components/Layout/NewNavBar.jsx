        ...
        <div className="container">
          <div id="navbar">
            ...
            <div>
              <ul
                id="nav_list"
                className={toggler ? "nav_list active-navbar" : "nav_list"}
              >
                  ...
                  <div className="dropdown">
                    ...
                    >
                      <div className="d-flex align-items-center">
                        ...
                        <BiChevronDown
                          style={{ color: "#00155A", fontSize: "22px" }}
                        />
                      </div>
                    </button>
                    <div
                      className="dropdown-menu nav_drop_box"
                    ...
                    >
                      ...
                      <Link
                        onClick={() => setToggler(false)}
                        className="dropdown-item"
                        to="/product&service/hardware-solutions"
                      >
                        Hardware Solutions
                      </Link>
                      <Link
                        onClick={() => setToggler(false)}
                        className="dropdown-item"
                        to="/product&service/software-solutions"
                      >
                        Software Solutions
                      </Link>
                      <Link
                  ...
                  <div className="dropdown">
                    ...
                    >
                      <div className="d-flex align-items-center">
                        ...
                        />
                        <BiChevronDown
                          style={{ color: "#00155A", fontSize: "25px" }}
                        />
                      </div>
                    </button>
                    <div
